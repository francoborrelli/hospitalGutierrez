...
async function create(req, res, next) {
  const clinicalRecord = new ClinicalRecord({
    ...
    vaccinationObservation: req.body.vaccinationObservation,
    maturationObservation: req.body.maturationObservation,
    fisicTestObservation: req.body.fisicTestObservation,
    generalObservation: req.body.generalObservation,
